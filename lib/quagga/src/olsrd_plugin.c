...
static int
set_redistribute (const char *value, void *data
...
static int
set_exportroutes (const char *value, void *data
                  __attribute__ ((unused)), set_plugin_parameter_addon addon
                  __attribute__ ((unused)))
{
...
static int
set_distance (const char *value, void *data
              __attribute__ ((unused)), set_plugin_parameter_addon addon
              __attribute__ ((unused)))
{
  int distance;
...
static int
set_localpref (const char *value, void *data
               __attribute__ ((unused)), set_plugin_parameter_addon addon
               __attribute__ ((unused)))
{
  int b;
...
olsrd_plugin_init (void)
{
  ...
  olsr_start_timer (1 * MSEC_PER_SEC, 0, OLSR_TIMER_PERIODIC, &zebra_check,
                    NULL, 0);
